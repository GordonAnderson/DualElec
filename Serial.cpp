...
// Dual electrometer commands
  {"RADC",  CMDfunction, 1, (char *)ReadADC},                             // Read the selected ADC channel
  {"RAD5593",  CMDfunction, 1, (char *)ReadAD5593},                       // Read the selected ADC channel
  
// Low level ADC commands
  {"RADC0RAW", CMDint, 0, (char *)&LastADCval[0]},                        // Read last raw ADC reading
  {"SMODE0", CMDint, 1, (char *)&ADCmode[0]},                             // Sets ADC mode, 
                                                                          //           0 = No window mode
                                                                          ...
                                                                          //           5 = ADC value changed
  {"GMODE0", CMDint, 0, (char *)&ADCmode[0]},                             // Returns the current ADC mode
  {"STHRES0", CMDint, 1, (char *)&Threshold[0]},                          // Sets ADC change threshold in ADC counts
  {"GTHRES0", CMDint, 0, (char *)&Threshold[0]},                          // Returns ADC change threshold in ADC counts
  {"SUPPER0", CMDint, 1, (char *)&LowerLimit[0]},                         // Sets Upper limit in volts
  {"GUPPER0", CMDint, 0, (char *)&LowerLimit[0]},                         // Returns Upper limit in volts
  {"SLOWER0", CMDint, 1, (char *)&UpperLimit[0]},                         // Sets Lower limit in volts
  {"GLOWER0", CMDint, 0, (char *)&UpperLimit[0]},                         // Returns Lower limit in volts
